@echo off
:: ============================================
:: Obra Dinn Head Tracking - Uninstall
:: ============================================
...
set "GAME_EXE=ObraDinn.exe"
set "GAME_DISPLAY_NAME=Return of the Obra Dinn"
set "STEAM_FOLDER_NAME=ObraDinn"
set "ENV_VAR_NAME=OBRA_DINN_PATH"
...
set "LEGACY_DLLS=ObraDinnHeadTracking.pdb HeadTracking.Core.dll ObraDinn.HeadTracking.dll"
set "GOG_IDS="
set "SEARCH_DIRS="
:: --- END CONFIG BLOCK ---
